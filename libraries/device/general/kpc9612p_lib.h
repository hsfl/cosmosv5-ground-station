...
/*!
 * \file kpc9612p_lib.h
 * \brief Kantronics KPC-9612+ packet TNC driver.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_kpc9612p KPC-9612+
 *
 * Implements the command and control interface for the Kantronics KPC-9612+
 * dual-port packet TNC. Configures baud rates, manages port selection, and
 * provides packet send/receive using the KISS protocol backend.
 */
