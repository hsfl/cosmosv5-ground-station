...
/*!
 * \file kisstnc_lib.h
 * \brief Kantronics TNC via KISS protocol.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_kisstnc KissTNC
 *
 * Provides a driver for Kantronics TNCs operating in KISS mode. Handles
 * device-specific initialisation, mode switching, and wraps kisslib for packet
 * I/O. Use when interfacing COSMOS with a Kantronics TNC for amateur-radio
