...
/*!
 * \file ts2000_lib.h
 * \brief Kenwood TS-2000 transceiver control.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_ts2000 TS-2000
 *
 * Implements the CAT (Computer Aided Transceiver) serial interface for the
 * Kenwood TS-2000 all-band transceiver. Provides frequency, mode, and PTT
 * control used by the radio-tracking agent for Doppler-corrected satellite
