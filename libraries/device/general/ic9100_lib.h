...
/*!
 * \file ic9100_lib.h
 * \brief Icom IC-9100 transceiver control.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_ic9100 IC-9100
 *
 * Implements the CI-V serial interface for the Icom IC-9100 multi-band
 * transceiver. Provides frequency, mode, squelch, and PTT control for
 * automated satellite communication passes under COSMOS antenna tracking.
 */
