...
/*!
 * \file kisslib.h
 * \brief KISS protocol framing for TNC communication.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_kisslib KISS
 *
 * Implements the Keep It Simple Stupid (KISS) protocol used to communicate
 * with Terminal Node Controllers (TNCs). Provides frame encoding and decoding
 * functions for wrapping AX.25 packets in KISS frames over a serial or TCP
 * connection.
 */
