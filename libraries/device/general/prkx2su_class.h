...
/*!
 * \file prkx2su_class.h
 * \brief PRKX2SU rotator object-oriented interface.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_prkx2su_class PRKX2SU Class
 *
 * Provides a C++ class wrapping the PRKX2SU antenna rotator driver
 * (prkx2su_lib) with RAII resource management and a state-machine for tracking
 * commanded and actual positions. Use in preference to the C-library when
 * writing new tracking agents.
 */
