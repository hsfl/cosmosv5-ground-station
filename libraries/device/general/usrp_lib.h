...
/*!
 * \file usrp_lib.h
 * \brief Ettus USRP software-defined radio control.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_usrp USRP
 *
 * Provides a COSMOS wrapper around the UHD (USRP Hardware Driver) API for
 * controlling Ettus Research USRP software-defined radios. Handles device
 * discovery, tuning, gain, sample rate, and streaming configuration for
 * satellite communication and signal monitoring applications.
 */
