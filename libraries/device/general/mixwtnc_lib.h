...
/*!
 * \file mixwtnc_lib.h
 * \brief MixW software TNC interface.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_mixwtnc MixW TNC
 *
 * Provides an interface to the MixW software TNC over its TCP control port.
 * Allows COSMOS to send and receive AX.25 frames through MixW's sound-card
 * modem without dedicated hardware TNCs.
 */
