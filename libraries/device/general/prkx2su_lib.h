...
/*!
 * \file prkx2su_lib.h
 * \brief PRKX2SU antenna rotator controller.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_prkx2su PRKX2SU
 *
 * Implements the serial command protocol for the PRKX2SU dual-axis antenna
 * rotator. Provides azimuth and elevation positioning commands and status
 * queries used by the COSMOS antenna-tracking agent.
 */
