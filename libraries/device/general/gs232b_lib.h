...
/*!
 * \file gs232b_lib.h
 * \brief Yaesu GS-232B antenna rotator controller.
 * \ingroup cosmos_ground_station_device
 * \defgroup cosmos_gs232b GS-232B
 *
 * Implements the GS-232B serial command protocol for the Yaesu antenna rotator
 * controller. Provides azimuth and elevation set/get functions used by the
 * antenna-tracking agent to point directional antennas at passing satellites.
 */
